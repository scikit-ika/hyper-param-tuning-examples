...
EvaluateModels(stream = stream, run = n_run, n_trees = nb_trees_init, n_samples_max = 5000, n_samples_meas = 500, metaModel=dictMeta)
# ###########
...
# nb_runs = 1
# 
# stream = [FileStream('./third_party/scikit_multiflow/src/skmultiflow/data/datasets/elec.csv'), 'Electricity']
#
# nb_trees_init = 10
...
# nb_runs = 1
# 
# stream = [FileStream('./third_party/scikit_multiflow/src/skmultiflow/data/datasets/covtype.csv'), 'CoverType']
#
# nb_trees_init = 10
# EvaluateModels(stream = stream, run = n_run, n_trees = nb_trees_init, n_samples_max = 45312, n_samples_meas = 200, metaModel=dictMeta)
# ###########
...
# nbTrees = [10,60,120]
# n_cores = 4
# datastream = [FileStream('./third_party/scikit_multiflow/src/skmultiflow/data/datasets/elec.csv'), 'Covtype']
# for nbTreesInit in nbTrees :
